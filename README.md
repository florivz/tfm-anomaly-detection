...
- **Abschluss:** LayerNorm bzw. Standardisierung über die resultierenden Vektoren. Die Dimensionsanpassung erfolgt in der PCA-Stufe (Variante 4), daher keine separaten lernbaren Projektionsschichten.
...
- binäre Klassifikation auf Basis der oben erläuterten ICC
...
# Limitationen
AnoLLM Batchsize = 2 wegen CUDA oom
TabPFN 4000 Zeilen als Kontext
