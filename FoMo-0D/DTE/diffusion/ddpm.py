"""
Part of the code is adapted from the ResNet prior (https://arxiv.org/abs/2106.11959)
provided at https://github.com/Yura52/rtdl and also adapted from https://github.com/rotot0/tab-ddpm
The prior was modified to integrate Time Embedding.
...
class ResNet(nn.Module):
    """The ResNet prior used in [gorishniy2021revisiting].
...
class DDPM():
    def __init__(self, seed=0, model_name = "DDPM", hidden_size = [256, 512, 256],
        ...
        def get_loss(model, x_0, t):
            ...
            # For the regression prior, the target is t with mean squared error loss
            loss_fn = nn.MSELoss()
