...
parser.add_argument('--prior',default='resnet34', type=str,help='the prior to take the embeddings: options are resnet34 and vicreg. If using vicreg, it will only generate CIFAR10 embeddings')
