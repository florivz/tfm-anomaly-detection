...
from data_prior.parallel_generator import PriorTrainDataGenerator
import pytorch_lightning as pl
from pytorch_lightning.loggers import WandbLogger
from pytorch_lightning.callbacks import ModelCheckpoint
import torch
from pfns.train_parallel import ZeroShotOD
import numpy as np
import wandb
...
def make_pl_model(cfg, get_batch_function, seq_len, num_features, hps,
    ...
    pl_model = ZeroShotOD(cfg=cfg,  # the prior is the key. It defines what we train on.
                          ...
                          extra_prior_kwargs_dict={'num_features': num_features,
                                                   'hyperparameters': hps,
                                                   'pt_dataloader': {'num_workers': 8, 'pin_memory': True},
                                                   'num_R': num_R},
...
def main(cfg: DictConfig):
    ...
    wandb_logger = WandbLogger(project='FoMo_0D', name=config_details)
    wandb.login(key="xxxxxxxxxxxxxxxxxxxxxx")
